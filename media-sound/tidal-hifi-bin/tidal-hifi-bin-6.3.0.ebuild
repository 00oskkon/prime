...
SRC_URI="https://github.com/Mastermindzh/tidal-hifi/releases/download/${PV}-Mavy/tidal-hifi-${PV}.tar.gz -> ${P}.tar.gz"
...
src_prepare() {
	...
	rm -rf "${S}"/resources/app.asar.unpacked/node_modules/@parcel/watcher-linux-x64-musl || die
}
